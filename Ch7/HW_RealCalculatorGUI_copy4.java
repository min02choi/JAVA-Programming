...
public class HW_RealCalculatorGUI_copy4 implements ActionListener {
    Frame f;
    ...
    public HW_RealCalculatorGUI_copy4() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ((s.charAt(0) >= '0' && s.charAt(0) <= '9') || s.charAt(0) == '.') {
            ...
            if (idx_array == -1) {
                ...
                if (last.charAt(0) >= '0' && last.charAt(0) <= 9 || last.charAt(0) == '.') {
                    ...
                    bef_array.set(idx_array, last); // 수삭의 가장 마지막 값 갱신
                }
        ...
        // "+/-"를 누른 경우 --> 가장 최근 value값의 부호를 바꿔줌
            ...
            if (j.charAt(0) >= '0' && j.charAt(0) <= '9') {
                Double tem = Double.parseDouble(j) * (-1);
